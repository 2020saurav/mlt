...
{	
	...
	cfit = rpart(
					...
					parms = list(split = "gini"),	# "gini" and "information" (entropy)	# (b)
					control = rpart.control(
												cp = 0.001, 	# Threshold complexity parameter
												minsplit = 15, 	# Min no. of obs. for which the routine will even try to split 
												minbucket = 5,	# Min no. of obs in leaf. Default = minsplit/3
